  ...
  return (
    <section className="max-container">
      <h1 className="head-text">
        ...
        drop-shadow">Jae Won Lee</span>
      </h1>
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>Skilled Program Manager 
          and UX Researcher in United States, with three years 
          of experience in wireframing, prototyping, user testing, 
          and user research.</p>
      </div>
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>My diverse background includes roles in content review, 
          graphic design, and community management, 
          all contributing to a holistic approach to problem-solving.
